...
export function PawPrintIcon({ className = "w-5 h-5" }: IconProps) {
  return (
    <svg
      className={className}
      fill="none"
    ...
    >
      <path
        strokeLinecap="round"
        strokeLinejoin="round"
        d="M12 18.5c-2.5 2-6 1-6.5-2-.3-1.8 1.5-3.5 3-4.5 1-.7 2.2-1 3.5-1s2.5.3 3.5 1c1.5 1 3.3 2.7 3 4.5-.5 3-4 4-6.5 2Z"
      />
